...
class DataId:
    ...
    DATA_SPLIT_TASK = "split_task"
    DATA_SPLIT_RESULT = "split_results"
...
if __name__ == "__main__":
    event = DataEvent(DataEvent.DATA_INVALIDATE, DataId(DataId.DATA_BODY, 1), dvidenv.DvidEnv("emdata1.int.janelia.org", 8500, "372c"))
    print(event)
